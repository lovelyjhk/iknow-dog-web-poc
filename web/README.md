...
영상 URL 입력은 브라우저가 직접 재생할 수 있는 공개 MP4/WebM 원본 링크를 우선 지원합니다. YouTube/Shorts 링크는 오류 153 같은 임베드 제한을 피하기 위해 썸네일과 외부 열기 버튼으로 표시하고, 정식 AI 분석은 직접 촬영 파일 또는 원본 영상 URL 기준으로 처리합니다.
